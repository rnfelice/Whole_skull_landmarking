...
source("C:/Users/carlb/Box Sync/Carla Bardua/code from lab/resamplingsV3.R")
#set the working directory
setwd("C:/Users/carlb/Box Sync/Carla Bardua/Temnospondyls/Testing_Checkpoint_27_01/pts")
​
#curvedata must be a csv with columns 'lm1' 'lm2' and 'ptswanted'
curvedata<-read_csv("C:/Users/carlb/Box Sync/Carla Bardua/Temnospondyls/Testing_Checkpoint_27_01/new curves_temnos_test.csv")
