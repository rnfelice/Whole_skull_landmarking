...
lm_to_mirror <- ptsbatch[-c(1:15,19:24,67:79,83:86,120:123, 124:1408),,] #take away the extra lms and curves 
#lm_to_mirror2 <- lm_to_mirror[-c(corressLHS),,] #this takes away the corresponding lms on the LHS
curves_to_mirror <- ptsbatch[-c(1:123, 124:448, 1084:1408),,] #take away the extra curves and landmarks (corresponding curves) and the odont curves
